...
public class SmoothQuadTo extends BasePathElement
{

	@Override
	public Type getType()
	{
		return Type.SMOOTH_QUAD;
	}

	private double x;
	private double y;

	public SmoothQuadTo(double x, double y)
	{
		this(true, x, y);
	}

	public SmoothQuadTo(boolean isRelative, double x, double y)
	{
		super(isRelative);
		this.x = x;
		this.y = y;
	...
	public boolean equals(Object obj)
	{
		...
		SmoothQuadTo other = (SmoothQuadTo) obj;
